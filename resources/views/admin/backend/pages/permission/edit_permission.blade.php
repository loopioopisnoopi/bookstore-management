                            ...
                            <form action="{{ route('update.permission') }}" method="post" class="row g-3"
                                ...
                                <div class="col-md-6">
                                    ...
                                    <select name="group_name" class="form-select" id="example-select">
                                        ...
                                        <option value="Product" {{ $permissions->group_name == 'Product' ? 'selected' : '' }}>
                                            Product</option>
                                        <option value="Purchase" {{ $permissions->group_name == 'Purchase' ? 'selected' : '' }}>Purchase</option>
                                        <option value="Sale" {{ $permissions->group_name == 'Sale' ? 'selected' : '' }}>Sale
                                        </option>
                                        <option value="Due" {{ $permissions->group_name == 'Due' ? 'selected' : '' }}>Due
                                        </option>
                                        <option value="Transfers" {{ $permissions->group_name == 'Transfers' ? 'selected' : '' }}>Transfers</option>
                                        <option value="Report" {{ $permissions->group_name == 'Report' ? 'selected' : '' }}>
                                            Report</option>
