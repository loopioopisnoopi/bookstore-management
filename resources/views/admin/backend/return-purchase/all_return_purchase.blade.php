                                ...
                                <tbody>
                                    @foreach ($allData as $key => $item)
                                        <tr>
                                            ...
                                            <td>
                                                <a title="Xem chi tiết" href="{{ route('details.return.purchase', $item->id) }}"
                                                    class="btn btn-info btn-sm"> <span
                                                        class="mdi mdi-eye-circle mdi-18px"></span> </a>

                                                <a title="Xuất hóa đơn PDF"
                                                    href="{{ route('invoice.return.purchase', $item->id) }}"
                                                    class="btn btn-primary btn-sm"> <span
                                                        class="mdi mdi-download-circle mdi-18px"></span> </a>

                                                <a title="Chỉnh sửa" href="{{ route('edit.return.purchase', $item->id) }}"
                                                    class="btn btn-success btn-sm"> <span
                                                        class="mdi mdi-book-edit mdi-18px"></span> </a>

                                                <a title="Xóa" href="{{ route('delete.return.purchase', $item->id) }}"
