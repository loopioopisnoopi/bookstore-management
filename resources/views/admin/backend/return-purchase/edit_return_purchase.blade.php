   ...
   <div class="d-flex flex-column-fluid">
      <div class="container-fluid my-4">
         <div class="d-md-flex align-items-center justify-content-between">
            <h3 class="mb-0">Chỉnh sửa phiếu nhập trả</h3>
            <div class="text-end my-2 mt-md-0"><a class="btn btn-outline-primary" href="{{ route('all.purchase') }}">Quay lại</a></div>
         </div>
 ...
 <div class="col-xl-12">
       ...
       <div class="row">
        ...
        <input type="hidden" name="warehouse_id" value="{{ $editData->warehouse_id }}">
          ...
          <div class="col-md-4 mb-3">
                ...
                <label class="form-label" for="formBasic">Kho: <span class="text-danger">*</span></label>
   ...
   <option value="">Chọn kho</option>
    ...
    @endforeach
          ...
          <div class="col-md-4 mb-3">
             <div class="form-group w-100">
                <label class="form-label" for="formBasic">Nhà cung cấp: <span class="text-danger">*</span></label>
       ...
       <div class="row">
          <div class="col-md-12 mb-3">
             ...
             <div class="input-group">
                   ...
                   <input type="search" id="product_search" name="search" class="form-control" placeholder="Tìm sách theo mã hoặc tên">
             </div>
  ...
  <div class="row">
     <div class="col-md-12">
      <label class="form-label">Danh sách sách nhập trả: <span class="text-danger">*</span></label>
 ...
 <div class="col-md-6 ms-auto">
    <div class="card">
      ...
      <div class="row">
         ...
         <div class="col-md-4">
            <div class="form-group w-100">
               <label class="form-label" for="formBasic">Trạng thái: <span class="text-danger">*</span></label>
      ...
      <div class="col-md-12 mt-2">
         ...
         <textarea class="form-control" name="note" rows="3" placeholder="Nhập ghi chú">{{ $editData->note }}</textarea>
      </div>
   </div>
</div>
</div>
