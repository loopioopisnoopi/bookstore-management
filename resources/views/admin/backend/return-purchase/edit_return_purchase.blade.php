                     ...
                     <div class="row">
                        <div class="col-xl-12">
                           <div class="card">
                              ...
                              <div class="row">
                                 <div class="col-md-12">
                                    <label class="form-label">Danh sách sách nhập trả: <span
                                          class="text-danger">*</span></label>
                                             ...
                                             <tr data-id={{ $item->id  }}>
                                                ...
                                                <td class="d-flex align-items-center gap-2">
                                                   <input type="text" class="form-control"
                                                      value="{{ $item->product->code }} - {{ $item->product->name }}" readonly
                                                      style="max-width: 300px">
                                                   <button type="button" class="btn btn-primary btn-sm edit-discount-btn"
                                                      data-id="{{ $item->id }}" data-name="{{ $item->product->name }}"
                                                      data-cost="{{ $item->net_unit_cost }}" data-bs-toggle="modal"
                                                ...
                                                <td>
                                                   <input type="number"
                                                      ...
                                                      class="form-control net-cost" value="{{ $item->net_unit_cost }}"
                                                      style="max-width: 90px;" readonly>

                                                </td>
                                                <td>
                                                   <input type="number" name="products[{{ $item->product->id }}][stock]"
                                                      class="form-control" value="{{ $item->product->product_qty }}"
                                                ...
                                                <td>
                                                   <input type="number" class="form-control discount-input"
                                                      ...
                                                      value="{{ $item->discount }}" style="max-width: 100px;">
                                                </td>

                                                <td class="subtotal">{{ number_format($item->subtotal, 2) }}</td>
                                                <input type="hidden" name="products[{{ $item->product->id }}][subtotal]"
                                                   value="{{ $item->subtotal }}">
                                 ...
                                 <div class="col-md-4">
                                    <div class="form-group w-100">
                                       ...
                                       <select name="status" id="status" class="form-control form-select">
                                          ...
                                          <option value="Return" {{ $editData->status == 'Return' ? 'selected' : '' }}>Return
                                          </option>
                                          <option value="Pending" {{ $editData->status == 'Pending' ? 'selected' : '' }}>
                                             Pending</option>
                                          <option value="Ordered" {{ $editData->status == 'Ordered' ? 'selected' : '' }}>
                                             Ordered</option>
                                       </select>
                                       @error('status')
                                          <span class="text-danger">{{ $message }}</span>
